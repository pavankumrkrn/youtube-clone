                        ...
                        <div className="p-5">
                            <div className="row">
                                <div className=" col-lg-9 col-md-9 col-sm-12 content">
                                    <p className="h5"><HistoryIcon /> History</p>
                                    {(user.history.length) ? <a className="text-primary txt"
                                    ...
                                    <hr />
                                    <p className="h5"><AccessTimeIcon /> Watch-Later</p>
                                    {(user.playlists.watchlater.length) ? <a className="text-primary txt"
                                    ...
                                    <hr />
                                    <p className="h5"><PlaylistPlayIcon /> PlayLists</p>
                                    <hr />
                                    <div className="row">
                                        {Object.keys(user.playlists).map((i, index) => {
                                            return (
                                                <div className="col-lg-3 col-md-3 col-sm-12" key={index}
                                                    ...
                                                    <div className="card">
                                                        <img src="https://cdn0.iconfinder.com/data/icons/influencer-solid/48/playlist_video_movie_youtube-512.png"
                                                            alt="" className="card-img-top"
                                                        />
                                                        <div className="card-body">
                                                            <div className="card-text">
                                                                <p className='text-center h6'>{i}</p>
                                                                <p className='text-center'>{user.playlists[i].length + ' videos'}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
