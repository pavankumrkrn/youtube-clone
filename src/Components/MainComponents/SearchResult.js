...
const SearchResult = () => {
    ...
    const url = `https://youtube.googleapis.com/youtube/v3/search?part=snippet&q=${params.text}&maxResults=30&key=AIzaSyA8_QL_C34H63d5sT1vMn-JF3SXeo69GEk`
                                                ...
                                                <div className="card col-sm-12 hisCard">
                                                    <div className="row">
                                                        <div className="col-lg-3 col-md-3 col-sm-12">
                                                            <div className="card">
                                                                <img src={i.snippet.thumbnails.high.url} alt="" className="card-img-top" onClick={() => push('/playvideo/' + i.id.videoId)} /></div>
                                                        </div>
